...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/floral-term-5eac
```

A live public deployment of this template is available at [https://floral-term-5eac.templates.workers.dev](https://floral-term-5eac.templates.workers.dev)
